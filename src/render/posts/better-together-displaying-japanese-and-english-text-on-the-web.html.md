...
tagged: ["web"]
keyimg: "https://hxlntblob.blob.core.windows.net/nbm/akazukinchacha.PNG"
feature: true
---
...
![Akazukin Chacha](https://hxlntblob.blob.core.windows.net/nbm/akazukinchacha.PNG)
...
![No encoding](https://hxlntblob.blob.core.windows.net/nbm/noutf.PNG)
...
![m7kenji interview](https://hxlntblob.blob.core.windows.net/nbm/kenjiinterview.png)
...
![Zoomed-in image of Japanese text in Chrome (PC)](https://hxlntblob.blob.core.windows.net/nbm/kenjizoomHL.png)
...
![Times New Roman + Arial Narrow](https://hxlntblob.blob.core.windows.net/nbm/tnr-an.png)  
...
![Chrome browser samples](https://hxlntblob.blob.core.windows.net/nbm/fonts1-1.png)

![Edge/Safari rowser samples](https://hxlntblob.blob.core.windows.net/nbm/fonts1-2.png)
