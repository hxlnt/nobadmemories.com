...
With a little experimentation, you can add other Japanese system fonts to existing web-safe CSS font stacks. PCs and Macs have their own sets of Japanese fonts, and user distribution of these fonts isn't going to be incredibly high, so these fonts should be incorporated with plenty of fallbacks. On a Mac, the Hiragino Kaku family meshes well with the Arials, while Microsoft's Yu Gothic fits right in with Segoe. If you go this route, [CSS Font Stack](http://www.cssfontstack.com/) could be a useful resource.
