...
## My recent inspirations and obsessions
  - *A Different World*
  - gardening
  - generative-art Twitter bots
  - *Kimagure Orange Road*
  - Sun Ra

## My tech stack
  - For NES development, I use NESASM 3 (compiler), YY-CHR (graphics tool), [FamiTracker](http://www.famitracker.com/) (music tool), FCEUX (emulator), HxD (hex editor), and [VS Code](http://code.visualstudio.com) (IDE). I often use Photoshop for early planning and design as well.
  - For Javascript and web development, I use [npm](http://npmjs.org) (package manager), [VS Code](http://code.visualstudio.com) (IDE/debugger), and Chrome.
...
## Art and design theory books for coders
  - *[As Long as It's Pink: The Sexual Politics of Taste](https://www.amazon.com/As-Long-Its-Pink-Politics/dp/0919616518)* by Penny Sparke
...
## Learning and making with code
### 8-bit consoles and computers (ASM/BASIC)
...
## Art+code people
  - [Andrew Reitano](http://www.andrewreitano.com/) (NYC)
