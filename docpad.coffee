...
docpadConfig =
	...
	plugins:
		moment:
			formats: [
				{raw: 'date', format: 'MMMM D', formatted: 'momentDate'}
				{raw: 'date', format: 'YYYY', formatted: 'momentYear'}
				{raw: 'date', format: 'h:mm A', formatted: 'momentTime'}
				{raw: 'enddate', format: 'MMMM D', formatted: 'momentEndDate'}
				]
		dateurls:
	...
	templateData:
		...
		site:
			...
			description: """
				No Bad Memories >> Rachel Simone Weil is an experimental designer whose work concerns alternative histories of computing and video games.
				"""

			# The website keywords (for SEO) separated by commas
			keywords: """
				no bad memories, rachel weil, party time hexcellent, nes, nesdev, femicom
				"""
			...
			scripts: [
				...
				<script>https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.3.0/Chart.bundle.min.js</script>
				"""
